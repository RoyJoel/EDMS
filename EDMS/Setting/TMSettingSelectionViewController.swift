//
//  EDSettingSelectionViewController.swift
//  TennisMoment
//
...
class EDSettingSelectionViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    var selectedRow: Int?
    ...
    override func viewDidLoad() {
        ...
        selectionTableView.register(EDSettingSelectionCell.self, forCellReuseIdentifier: "EDSettingSelectionCell")
    ...
    func select(at indexPath: IndexPath) {
        ...
        let cell = selectionTableView.cellForRow(at: indexPath) as? EDSettingSelectionCell

...
class EDBillingViewController: UIViewController {
    var order = Order()
    ...
    lazy var billView: EDBillingView = {
        let view = EDBillingView()
        return view
    }()

    lazy var addressView: EDAddressView = {
        let view = EDAddressView()
        return view
    }()

    lazy var wayOfPayView: EDPaymentView = {
        let view = EDPaymentView()
        return view
    }()

//
//  EDGameStatsDetailViewController.swift
//  TennisMoment
//
...
class EDGameStatsDetailViewController: UIViewController {
    var game: Game = Game()
    var games: [Game] = []
...
//        player2IconView.addTapGesture(self, #selector(seePlayerInfo(sender:)))
    ...
    func setupEvent(game: Game) {
        ...
        let result = EDDataConvert.gameResult(from: game.result, isGameCompleted: true)
    ...
    func searchH2H(player1: Int, player2: Int) {
        ...
        for game in games {
            let result = EDDataConvert.setResult(from: game.result, isGameCompleted: true)
    ...
    func searchH2H(for player1Id: Int, and player2Id: Int) -> [Game] {
        ...
        for game in EDUser.user.allHistoryGames {
...
//        let vc = EDCommonPlayerInfoViewController()
//        if let tappTMView = sender.view {
//            if tappTMView == player1IconView {
//                // Do something for player 1
//                vc.player = game.player1
//            } else if tappTMView == player2IconView {

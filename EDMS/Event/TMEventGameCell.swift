...
class EDEventGameCell: UITableViewCell {
...
//
//    /// 记分板
//    lazy var recordPointView: EDPointRecordView = {
...
//        let pointRecordViewConfig = EDPointRecordViewConfig(rowHeight: 28, rowSpacing: 0, font: UIFont.systemFont(ofSize: 13), isTitleHidden: true, isPlayer1Serving: true, isPlayer1Left: true, isGameCompleted: true, player1SetNum: 0, player2SetNum: 0, player1GameNum: 0, player2GameNum: 0, player1PointNum: "0", player2PointNum: "0")

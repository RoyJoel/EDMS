...
class EDH2HViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        if h2hGames.count == 0 {
            ...
            H2HRecordView.register(EDH2HRecordCell.self, forCellReuseIdentifier: "EDRecordCell")
    ...
    func tableView(_: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.row == 0 {
            let cell = EDH2HContentLabelCell()
            return cell
        } else {
            let cell = EDH2HRecordCell()

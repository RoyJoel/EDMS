//
//  EDUserAllHistoryGamesViewController.swift
//  TennisMoment
//
...
class EDUserAllHistoryGamesViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_: UITableView, numberOfRowsInSection _: Int) -> Int {
        EDUser.user.allHistoryGames.count
    }
    ...
    func tableView(_: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.setupEvent(game: EDUser.user.allHistoryGames[indexPath.row])
        return cell
    }

    func tableView(_: UITableView, didSelectRowAt indexPath: IndexPath) {
        let vc = EDGameStatsDetailViewController()
        vc.game = EDUser.user.allHistoryGames[indexPath.row]

...
// func test() {
//    EDGameRequest.searchAllGames(for: "p") { games in
//        print(games)
//    }
...
//    EDPlayerRequest.addPlayer(player: player5) { player in
//        print(player)
//    }
//    EDGameRequest.addGame(game: game3) { result in
//        print(result)
//    }
...
//    EDStatsRequest.updateStats(stats: stats) { stats in
//        print(stats)
//
//        EDStatsRequest.searchStats(id: 78) { stats in
//            print(stats)
//        }
//    }
...
//    EDGameRequest.addGame(game: game1) { res in
//        print(res)
//    }
...
//        print(games)
//    }
//    EDGameRequest.saveGame(game: game2)
//
...
//    let a = EDNetWork.get("/player/getAll") { json, _ in

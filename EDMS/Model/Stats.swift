...
struct Stats: Codable, Equatable {
    ...
    func convertToRealStats() -> statsData {
        let firstServeIn = EDDataConvert.Divide(firstServePointsIn, by: firstServePoints)
        let firstServeWon = EDDataConvert.Divide(firstServePointsWon, by: firstServePointsIn)
        let secondServeIn = EDDataConvert.Divide(secondServePointsIn, by: servePoints - firstServePoints)
        let secondServeWon = EDDataConvert.Divide(secondServePointsWon, by: secondServePointsIn)
        let firstReturnServeIn = EDDataConvert.Divide(firstServeReturnPointsIn, by: firstServeReturnPoints)
        let firstReturnServeWon = EDDataConvert.Divide(firstServeReturnPointsWon, by: firstServeReturnPointsIn)
        let secondReturnServeIn = EDDataConvert.Divide(secondServeReturnPointsIn, by: returnServePoints - firstServeReturnPoints)
        let secondReturnServeWon = EDDataConvert.Divide(secondServeReturnPointsWon, by: secondServeReturnPointsIn)
        let breakPointSaved = EDDataConvert.Divide(breakPointsSaved, by: breakPointsFaced)
        let breakPointConvert = EDDataConvert.Divide(breakPointsConverted, by: breakPointsOpportunities)
        let serveGameWon = EDDataConvert.Divide(serveGamesWon, by: serveGamesPlayed)
        let returnGameWon = EDDataConvert.Divide(returnGamesWon, by: returnGamesPlayed)
        let servePointWon = EDDataConvert.Divide(firstServePointsWon + secondServePointsWon, by: firstServePointsIn + secondServePointsIn)
        let returnPointWon = EDDataConvert.Divide(firstServeReturnPointsWon + secondServeReturnPointsWon, by: firstServeReturnPointsIn + secondServeReturnPointsIn)
